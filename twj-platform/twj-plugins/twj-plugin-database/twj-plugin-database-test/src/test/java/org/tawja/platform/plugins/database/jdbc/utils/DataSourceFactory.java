...
public class DataSourceFactory {
    ...
    public static ConnectionPoolDataSource createDataSourceH2File() throws Exception {
        org.h2.jdbcx.JdbcDataSource dataSource = new org.h2.jdbcx.JdbcDataSource();
        dataSource.setURL("jdbc:h2:file:./target/databases/h2/testDbFile.db");
        return dataSource;
    }
    ...
    public static ConnectionPoolDataSource createDataSourceHsqlFile() throws Exception {
        ...
        dataSource.setUrl("jdbc:hsqldb:file:./target/databases/hsql/testDbFile");    // in-memory database
        return dataSource;
    }
}
