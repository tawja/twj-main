...
public abstract class AbstractExecutableMojo extends BaseMavenGruntMojo {
    ...
    /**
     * Should bower allowed as root user (default to true).
     */
    @Parameter(property = "allowRoot", defaultValue = "true")
    protected boolean allowRoot;
    
    /**
     * Version of exec plugin to use (defaults to 1.3.2).
     */
    @Parameter(property = "execMavenPluginVersion", defaultValue = "1.3.2")
