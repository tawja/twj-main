...
public class GeneratorMojoForJenkinContinuousDistTest extends AbstractMojoTestCase {

    private final File outputDirectory = new File("generated-sources/jenkins-continuous-dist/");
    private final File templateDirectory = new File("../../src/test/resources/jenkins-continuous-dist/templates/");
    private final File cfgFile = new File("../../src/test/resources/jenkins-continuous-dist/");
    ...
    private Mojo getConfiguredMojo() throws Exception {
        ...
        File pluginXml = new File(getBasedir(), "src/test/resources/jenkins-continuous-dist/plugin-config.xml");
