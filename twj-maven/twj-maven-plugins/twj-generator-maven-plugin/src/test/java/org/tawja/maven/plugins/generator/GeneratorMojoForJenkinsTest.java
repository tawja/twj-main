...
public class GeneratorMojoForJenkinsTest extends AbstractMojoTestCase {

    private final File outputDirectory = new File("generated-sources/jenkins/");
    private final File templateDirectory = new File("../../src/test/resources/jenkins/templates/");
    private final File cfgFile = new File("../../src/test/resources/jenkins/");
    ...
    private Mojo getConfiguredMojo() throws Exception {
        ...
        File pluginXml = new File(getBasedir(), "src/test/resources/jenkins/plugin-config.xml");
