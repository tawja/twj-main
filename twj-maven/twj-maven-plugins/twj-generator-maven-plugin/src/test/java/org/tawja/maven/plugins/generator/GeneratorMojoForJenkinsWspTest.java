...
public class GeneratorMojoForJenkinsWspTest extends AbstractMojoTestCase {

    private final File outputDirectory = new File("generated-sources/jenkins-wsp/");
    private final File templateDirectory = new File("../../src/test/resources/jenkins-wsp/templates/");
    private final File cfgFile = new File("../../src/test/resources/jenkins-wsp/");
    ...
    private Mojo getConfiguredMojo() throws Exception {
        ...
        File pluginXml = new File(getBasedir(), "src/test/resources/jenkins-wsp/plugin-config.xml");
