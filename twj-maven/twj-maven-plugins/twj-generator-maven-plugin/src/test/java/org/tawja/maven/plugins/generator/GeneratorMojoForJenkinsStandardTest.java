...
public class GeneratorMojoForJenkinsStandardTest extends AbstractMojoTestCase {

    private final File outputDirectory = new File("generated-sources/jenkins-standard/");
    private final File templateDirectory = new File("../../src/test/resources/jenkins-standard/templates/");
    private final File cfgFile = new File("../../src/test/resources/jenkins-standard/");
    ...
    private Mojo getConfiguredMojo() throws Exception {
        ...
        File pluginXml = new File(getBasedir(), "src/test/resources/jenkins-standard/plugin-config.xml");
