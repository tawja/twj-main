...
public class GeneratorMojoForJenkinsSimpleTest extends AbstractMojoTestCase {

    private final File outputDirectory = new File("generated-sources/jenkins-simple/");
    private final File templateDirectory = new File("../../src/test/resources/jenkins-simple/templates/");
    private final File cfgFile = new File("../../src/test/resources/jenkins-simple/");
    ...
    private Mojo getConfiguredMojo() throws Exception {
        ...
        File pluginXml = new File(getBasedir(), "src/test/resources/jenkins-simple/plugin-config.xml");
